  ...
  return (
    <main>
      ...
      <header className="topbar" aria-label="主导航">
        ...
        <nav>
          <Link href="/pc">线上守护</Link>
          <Link href="/elder">老人端</Link>
          <Link href="/guardian">家属通知端</Link>
        </nav>
        <span className="verified"><span aria-hidden="true">●</span> 三端协同</span>
      </header>
      ...
      <section className="hero product-hero" aria-labelledby="hero-title">
        <div className="hero-copy">
          ...
          <div className="hero-actions">
            <Link className="button primary" href="/pc">立即体验线上守护</Link>
            <Link className="button secondary" href="/elder">查看老人端</Link>
          </div>
